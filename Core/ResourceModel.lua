...
local SIMPLE = ResourceModel.SimpleSupport
...
local RESOURCE_DEFS = {
	...
	ROGUE_COMBO_POINTS = {
		...
		simpleSupport = SIMPLE.FULL,
		simpleSystemID = SYSTEMS.GENERIC_PIPS,
		sourceType = SOURCES.POWER,
